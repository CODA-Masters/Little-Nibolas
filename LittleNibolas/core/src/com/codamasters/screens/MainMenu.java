...
public class MainMenu implements Screen {
    ...
    public void show() {
            ...
            TextButton buttonSettings = new TextButton("Creditos", skin,"big");
            ...
            TextButton buttonRanking = new TextButton("Rankings", skin,"big");
            ...
            table.add(buttonRanking).spaceBottom(15).row();
            ...
            Timeline.createSequence().beginSequence()
                            ...
                            .push(Tween.set(buttonRanking, ActorAccessor.ALPHA).target(0))
                            ...
                            .push(Tween.to(buttonRanking, ActorAccessor.ALPHA, .25f).target(1))
