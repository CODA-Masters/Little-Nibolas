...
public class IntroPrimerNivel2 implements Screen {
	...
	public IntroPrimerNivel2(LittleNibolas game){
		this.game = game;
	}
	...
	public void show() {
		...
		splash = new Sprite(new Texture("data/Intro2.png"));
		...
		Tween.to(splash, SpriteAccessor.ALPHA, 1.5f).target(1).repeatYoyo(1, 3f).setCallback(new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				((Game) Gdx.app.getApplicationListener()).setScreen(new IntroPrimerNivel3(game));
